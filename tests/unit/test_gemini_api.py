...
class TestGeminiAPI:
    ...
    def test_analyze_text_with_gemini_invalid_api_key(self, mock_genai):
        ...
        with pytest.raises(Exception, match="Invalid API key"):
            analyze_text_with_gemini("Some text", "INVALID_KEY")
    ...
    @patch('gemini_api_handler.handle_api_error')  # Assuming you have error handling
    def test_analyze_text_with_gemini_api_error(self, mock_error_handler, mock_genai):
        ...
        mock_error_handler.return_value = {"error": "Failed to analyze text"}
        ...
        assert result["error"] == "Failed to analyze text"